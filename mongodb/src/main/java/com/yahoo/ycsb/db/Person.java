...
public class Person 
{
	...
	public boolean equals(Object obj) {
		return obj == this || 
				(obj instanceof DBObject && checkDbObj( ((DBObject) obj)) ) ||
				(obj instanceof Person && hasSameFields( ((Person) obj)) );
	}
	
	private boolean checkDbObj(DBObject obj) {
		return userId.equals(obj.get("_id")) &&
				firstName.equals(obj.get("firstName")) &&
				lastName.equals(obj.get("lastName")) &&
				birthDate == ((Integer) obj.get("birthDate")).intValue() &&
				company.equals(obj.get("company")) &&
				city.equals(obj.get("city")) &&
				address.equals(obj.get("address")) &&
				email.equals(obj.get("email")) &&
				streetname.equals(obj.get("streetname")) &&
				streetsuffix.equals(obj.get("streetsuffix")) &&
				personalnumber == ((Integer) obj.get("personalnumber")).intValue();
	}
